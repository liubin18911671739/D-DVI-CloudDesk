                    ...
                    [
                        {
                            "id": "limit1M",
                            "name": "上下限为 1Mbps",
                            "description": "将上行和下行限制为 1Mbps（125KBytes/s）和 10Mbps 的突发，最大 100MB 传输.",
                            "bandwidth": {
                                "inbound": {
                                    "@average": 125,
                                    "@peak": 1250,
            ...
            self.result(
                ...
                .insert(
                    [
                        {
                            "id": "limit50MBps",
                            "name": "带宽：50MBps/IOPS：10K",
                            "description": "将写入和读取限制为 50Mbps，将 IOPs 限制为 10K",
                            "iotune": {
                                # throughput limit in bytes per second.
